# Shinkai Project Android 16 Build Manifest for Redmi Note 12 Turbo / POCO F5 (marble)
...
```bash
curl https://raw.githubusercontent.com/nekoshirro/platform_manifest-marble/refs/heads/shinkai-16/shinkai.sh | bash
```
