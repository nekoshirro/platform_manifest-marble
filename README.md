# Shinkai Project Android 17 Build Manifest for Redmi Note 12 Turbo / POCO F5 (marble)
...
```bash
curl https://raw.githubusercontent.com/nekoshirro/platform_manifest-marble/refs/heads/shinkai-17/shinkai.sh | bash
```
