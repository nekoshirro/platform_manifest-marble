# The Clover Project Android 16 Build Manifest for Redmi Note 12 Turbo / POCO F5 (marble)
...
```bash
curl https://raw.githubusercontent.com/nekoshirro/platform_manifest-marble/refs/heads/clover-16/clover.sh | bash
```
